...
write_csv2(data1, "SZ_II/Generated_Data/binarized.csv")
write_csv2(data2_counted, "SZ_II/Generated_Data/Binarized_freq_count.csv")
write_csv2(datax, "SZ_II/Generated_Data/Binarized_Matched_freq_count.csv")
```
...
# save
pdf("Images/Top_100_Phenotypes_SZ_II.pdf", width=8, height=8)
fig1
dev.off() 
...
### Figure 1a
freq1_top_SZ_II <- freq1_top 
save(freq1_top_SZ_II , file = "SZ_II/Generated_Data/freq1_top_SZ_II.RData")

### Figure 1b
# Export m_pl & m_ln
res_pl_SZ_II <- plot(freq_distribution[[1]])
line_pl_SZ_II <- lines(freq_distribution[[1]])
line_ln_SZ_II <- lines(freq_distribution[[2]])
line_ex_SZ_II <- lines(freq_distribution[[3]])

save(res_pl_SZ_II, file = "SZ_II/Generated_Data/res_pl_SZ_II.RData")
save(line_pl_SZ_II, file = "SZ_II/Generated_Data/line_pl_SZ_II.RData")
save(line_ln_SZ_II, file = "SZ_II/Generated_Data/line_ln_SZ_II.RData")
save(line_ex_SZ_II, file = "SZ_II/Generated_Data/line_ex_SZ_II.RData")
```
