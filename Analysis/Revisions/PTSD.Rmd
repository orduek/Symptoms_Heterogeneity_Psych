...
# Order the data frame columns according to the correct order
data0_ordered <- dataCor[, correct_order]

library(Hmisc)
correlations <- rcorr(as.matrix(data0_ordered))
cor_mat <- correlations$r  # Extract correlation matrix

library(corrplot)
corrplot(cor_mat, order = "original", type = "upper", 
