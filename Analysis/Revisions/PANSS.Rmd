...
write_csv2(data1, "SZ/Generated_Data/binarized.csv")
write_csv2(data2_counted, "SZ/Generated_Data/Binarized_freq_count.csv")
write_csv2(datax, "SZ/Generated_Data/Binarized_Matched_freq_count.csv")
```
...
save(freq1_top_SZ , file = "SZ/Generated_Data/freq1_top_SZ.RData")
...
save(res_pl_SZ, file = "SZ/Generated_Data/res_pl_SZ.RData")
save(line_pl_SZ, file = "SZ/Generated_Data/line_pl_SZ.RData")
save(line_ln_SZ, file = "SZ/Generated_Data/line_ln_SZ.RData")
save(line_ex_SZ, file = "SZ/Generated_Data/line_ex_SZ.RData")
```
