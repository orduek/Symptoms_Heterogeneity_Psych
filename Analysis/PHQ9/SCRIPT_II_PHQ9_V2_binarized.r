...
data1_binarized<- read_delim("Analysis/PHQ9/Generated Data/binarized.csv", 
...
nrow(data2_counted) # 510

## Number of endorsements of most common phenotype
max(data2_counted$freq) # 22833
...
print(data2_counted[2,]) # All but 9
print(data2_counted[3,]) #  All  

## Median endorsement of phenotypes   ?!?!?!?!?!?!?!?!?
summary(datax$freq) # Median = 1616
...
pdf("Images/Top_100_Phenotypes_PHQ9_binarized.pdf", width=8, height=8)
...
pdf("PL_parameters_boot_PHQ9_binarized.pdf", width=8, height=8)
plot(bs_p)
dev.off() 
...
options(scipen=5)
pdf("Images/PL_ML_CDF_equal_Xmin_PHQ9_binarized.pdf", width=8, height=8)
...
compare_distributions(m_ln_EQ, m_pl)$p_one_sided #   p < 0.604 -> m_pl better fit


######  6. Export data for Figures ##############################################
### Figure 1a
freq1_top_PHQ <- freq1_top 
save(freq1_top_PHQ , file = "Analysis/PHQ9/Generated Data/freq1_top_PHQ9_binarized.RData")
...
save(res_pl_PHQ, file = "Analysis/PHQ9/Generated Data/res_pl_PHQ9B.RData")
save(line_pl_PHQ, file = "Analysis/PHQ9/Generated Data/line_pl_PHQ9B.RData")
save(line_ln_PHQ, file = "Analysis/PHQ9/Generated Data/line_ln_PHQ9B.RData")
