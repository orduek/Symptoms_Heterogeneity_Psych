...
data2_counted <- plyr::count(data2[, ]) # 39341
...
write_csv2(data2_counted, "Analysis/PHQ9/Generated Data/freq_count_nonB.csv")
write_csv2(datax, "Analysis/PHQ9/Generated Data/Matched_freq_count_nonB.csv")
